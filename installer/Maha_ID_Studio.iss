...
#define MyAppVersion "10.36"
#define MyAppPublisher "SEEMA DIGITAL"
#define MyAppExeName "MAHA ID SOFTWARE 10.36.exe"

[Setup]
AppId={{281D2A77-F8D9-45F3-A579-10360000C0DE}
AppName={#MyAppName}
...
DefaultDirName={localappdata}\Programs\Seema Digital\Maha ID Studio 10.36
DefaultGroupName=SEEMA DIGITAL 10.36
PrivilegesRequired=lowest
OutputDir=output
OutputBaseFilename=MAHA ID SOFTWARE 10.36 Setup
...
VersionInfoProductVersion=10.36.0
...
Source: "..\dist\MAHA ID SOFTWARE 10.36 Remover.exe"; DestDir: "{app}"; Flags: ignoreversion
...
Name: "{autodesktop}\Maha ID Studio 10.36"; Filename: "{app}\{#MyAppExeName}"; WorkingDir: "{app}"; IconFilename: "{app}\{#MyAppExeName}"; Tasks: desktopicon
Name: "{group}\Maha ID Studio Remover"; Filename: "{app}\MAHA ID SOFTWARE 10.36 Remover.exe"; WorkingDir: "{app}"; IconFilename: "{app}\MAHA ID SOFTWARE 10.36 Remover.exe"
