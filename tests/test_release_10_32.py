...
class Release1032Tests(unittest.TestCase):
    def test_product_version_and_exact_home_copy(self):
        self.assertEqual((app.PRODUCT_NAME,app.APP_VERSION),("MAHA ID SOFTWARE","10.36"))
    ...
    def test_exact_release_filename(self):
        ...
        for text in ("MAHA ID SOFTWARE 10.36.exe","MAHA ID SOFTWARE 10.36 Setup.exe","MAHA ID SOFTWARE 10.36.zip"):self.assertIn(text,data)
